# TODO skipped tests: preloading issue - https://stackoverflow.com/questions/49996642/ecto-remove-preload/49997873#49997873
defmodule Api.ChannelsTest do
  ...
  describe "channel_groups" do
    ...
    test "update_channel_group/2 with valid data updates the channel_group" do
      ...
      assert {:ok, %ChannelGroup{} = channel_group} =
               Channels.update_channel_group(channel_group, update_attrs)
    ...
    test "update_channel_group/2 with invalid data returns error changeset" do
      ...
      assert {:error, %Ecto.Changeset{}} =
               Channels.update_channel_group(channel_group, @invalid_attrs)
